...
* **Cámara cenital completa (paneo/zoom, selección de tropas por arrastre):** la versión implementada aquí es deliberadamente mínima — solo lo necesario para pintar zonas. La versión completa es PoC 6 (Fase 4, ver GDD Sección 11 v3.14 — se corrió de Fase 3 a Fase 4 al insertarse "Mundo Procedural y Puestos de Recolección" antes). Ver 2.6.
