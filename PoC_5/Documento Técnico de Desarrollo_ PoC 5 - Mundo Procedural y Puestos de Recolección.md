...
Esta PoC cubre los **3 primeros sub-proyectos de 4** de la Fase 3 del roadmap (GDD Sección 11 v3.20): Mundo Procedural Finito, Nivelación de Terreno sobre Relieve y Puestos de Recolección + previsualización en HUD (con alcance reducido a minas — ver 3.8). Generación de Cuerpos de Agua (agregada en v3.20, GDD Sección 4 "Sistema de Puentes") queda para el sub-proyecto posterior.
...
* **Generación de Cuerpos de Agua** (GDD Sección 4, "Sistema de Puentes"): cuarto sub-proyecto de esta Fase, agregado en v3.20 — sin diseño todavía. Resuelve la dependencia de agua tanto de los puestos de caza/recolección (sub-proyecto 3, Sección 3: "cerca de... ríos o lagos con peces") como de los puentes sobre agua (Sección 4, Fase 5/PoC 9).
...
> 4. **Generación de Cuerpos de Agua** (nuevo, agregado en GDD v3.20 tras la Sección 4 "Sistema de Puentes"): ríos y lagos reales en el mundo procedural — sin esto, ni los puentes sobre agua (GDD Sección 4, Fase 5/PoC 9) ni los puestos de caza/recolección junto a agua (sub-proyecto 3, arriba) tienen dónde emplazarse. Sin diseño todavía (algoritmo de generación, criterio de "cuerpo de agua" para el flood-fill/pathfinding de puentes, interacción con `GeneradorMundo.altura_en()`) — brainstorming pendiente antes de spec/plan.
