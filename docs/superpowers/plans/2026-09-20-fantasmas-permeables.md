...
| `godot/scripts/ColonosTest.gd` | Modificar | Pruebas 13-14 (evacuación) |
...
- [ ] **Step 1: Ampliar el mundo falso y agregar las pruebas 13 y 14 (fallarán)**
...
Antes del `print` final, agregar (y cambiar el final a `Las 14 pruebas`):

```gdscript
	print("\n=== TEST 13: Un colono dentro de una obra recibe permiso, sale y no puede volver a entrar ===")
	...
	print("\n=== TEST 14: Un colono fuera de la obra no recibe permiso ni cambia lo que hace ===")
...
Expected: PASS con `=== Las 14 pruebas de Colonos pasaron correctamente ===`.
